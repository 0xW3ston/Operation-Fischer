...
<head>
  ...
  <link href="{{ asset('assets/admin/vendor/toastr/toastr.min.css') }}" rel="stylesheet">
  @yield('extra-head')
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('admin.dashboard') }}" class="logo d-flex align-items-center">
        <img src="{{ asset('assets/admin/img/logo_secure_admin.png') }}" width="28px" height="28px" alt="">
        <span class="d-none d-lg-block">Fischer</span>
      </a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            <li class="dropdown-header">
              You have {{ count($notifications) !== 0 ? count($notifications) : "no"}} new notifications
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item my-2">
          <a class="nav-link collapsed" href="{{ route('admin.categorie.all') }}">
      ...
      <li class="nav-item my-2">
          <a class="nav-link collapsed" href="{{ route('admin.product.all') }}">
      ...
      <li class="nav-item my-2">
          <a class="nav-link collapsed" href="{{ route('admin.commande.all') }}">
