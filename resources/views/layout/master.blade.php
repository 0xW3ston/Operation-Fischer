...
<head>
    ...
    <title>E-Commerce - 0xW3ston</title>
...
<body>
    ...
    <header class="oleez-header">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="{{ route('client.dashboard') }}"><img src="{{ asset('assets/client/images/logo/logo_a.png') }}" alt="Oleez" width="60px" height="60px"></a>
            <ul class="nav nav-actions d-lg-none ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="#!" data-toggle="searchModal">
                        <img src="{{ asset('assets/client/images/search.svg') }}" alt="search">
                    </a>
                </li>
                <li class="nav-item nav-item-cart">
                    <a class="nav-link" href="{{ route('client.cart') }}">
                        <span class="cart-item-count">0</span>
                        <img src="{{ asset('assets/client/images/shopping-cart.svg') }}" alt="cart">
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#!" data-toggle="offCanvasMenu">
                        <img src="{{ asset('assets/client/images/social icon@2x.svg') }}" alt="social-nav-toggle">
                    </a>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse" id="oleezMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('client.dashboard') }}">Home <span class="sr-only"></span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('client.products') }}">Products <span class="sr-only"></span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('client.categories') }}">Categories <span class="sr-only"></span></a>
                    </li>
                    {{-- <li class="nav-item">
                ...
                <ul class="navbar-nav d-none d-lg-flex">
                    ...
                    <li class="nav-item nav-item-cart">
                        <a class="nav-link nav-link-btn" href="{{ route('client.cart') }}">
                            <span class="cart-item-count">0</span>
                            <img src="{{ asset('assets/client/images/shopping-cart.svg') }}" alt="cart">
                        </a>
                    </li>
    ...
    <footer class="oleez-footer wow fadeInUp">
        <div class="container">
            <div class="footer-content">
                <div class="row">
                    <div class="col-md-6">
                        <img src="{{ asset('assets/client/images/logo/logo_a.png') }}" alt="oleez" class="footer-logo">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6 footer-widget-text">
                                ...
                                <p class="widget-content">info@e</p>
                            </div>
                            <div class="col-md-6 footer-widget-text">
    ...
    <div id="searchModal" class="search-modal">
        ...
        <li class="nav-item active">
            <a class="nav-link nav-link-btn" href="#!" data-toggle="searchModal">
                <img src="http://localhost:8000/assets/client/images/search.svg" alt="search">
            </a>
        </li>
    </div>
