            ...
            <div class="card-body pt-3">
                ...
                <div class="container mt-4">
                    <div class="input-group mb-3">
                        <form action="{{ route('admin.product.all') }}" method="GET" class="d-flex">
                    ...
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="{{ route('admin.product.edit',['id' => $item->id])}}"><i class="bi bi-gear-wide-connected"></i></a>
                                    <a class="btn btn-danger" href="{{ route('admin.product.delete',['id' => $item->id])}}"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
